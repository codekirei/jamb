...
//----------------------------------------------------------
/**
  Generate sitemap with sitemap.js.

  @param {Object[]} content - array of content data
  @param {String} hostname - base url of site to map
  @returns {String} generated sitemap
 */
const genSitemap = (content, hostname) =>
  sm.createSitemap(
    { hostname
    , urls: content.map(ob => Object.assign({}, {url: ob.sitemapUrl}))
    }
  ).toString()
